...
function Hero() {
  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col justify-between max-h-[35rem] min-w-0 opacity-0 about-div -translate-x-200">
      ...
      <div className="flex-1 self-stretch flex items-center justify-end min-w-0 mr-8">
        <div className="container img-container relative shadow-md z-10 w-full opacity-0 translate-x-100 -rotate-0 h-full origin-center min-w-[15rem] min-h-[18rem] max-h-[28rem] max-w-[22rem] md:max-h-[25rem] md:max-w-[25rem] bg-background/[0.1] border border-background/[0.5] rounded-xl">
          <div className="back-container img-container-div absolute w-full h-full bg-background/[0.2] shadow-md rounded-xl rotate-0 backdrop-blur origin-center border border-background/[0.5]">
            <Image
